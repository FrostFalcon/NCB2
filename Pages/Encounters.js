let groups = {
    ...
    "Fourth Gym" : ["Pinwheel Forest 2", "Route 3", "Wellspring Cave", "Dreamyard 1", "Dreamyard 2", "Desert Resort", "Relic Castle", "Route 5", "Route 16", "Lostlorn Forest"],
    "Fifth Gym" : ["Route 6", "Chargestone Cave", "Clay Tunnel"],
    "Sixth Gym" : ["Relic Passage 2", "Mistralton Cave", "Route 7", "Celestial Tower"],
